...
class SubjectChooserForFillQuetion extends JFrame implements ItemListener, ActionListener {
...
//	static String subject;
	...
	SubjectChooserForFillQuetion(String ttl) {
		super(ttl);
	...
	public void actionPerformed(ActionEvent e) {
		...
		new QuestionFillGUI("QuestionFillGUI");
	}
	...
	public static void main(String args[]) {
		new SubjectChooserForFillQuetion("SubjectChooserForFillQuetion");
	}
}
